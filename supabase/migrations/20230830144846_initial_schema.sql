drop policy "Enable insert for authenticated users only" on "public"."User Astrological Details Report";

drop policy "Enable read for authenticated users based on user_id" on "public"."User Astrological Details Report";

drop policy "Enable update for users based on user_id" on "public"."User Astrological Details Report";

alter table "public"."User Astrological Details Report" drop constraint "User Astrological Details Report_user_id_fkey";

alter table "public"."Astrological Details Report" drop constraint "Astrological Details Report_pkey";

alter table "public"."User Astrological Details Report" drop constraint "Astrological Details _pkey";

drop index if exists "public"."Astrological Details Report_pkey";

drop index if exists "public"."Astrological Details _pkey";

drop table "public"."Astrological Details Report";

drop table "public"."User Astrological Details Report";
